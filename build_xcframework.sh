...
​
# Archive steps
xcodebuild archive -scheme web3.swift-Project -sdk iphoneos BUILD_LIBRARY_FOR_DISTRIBUTION=YES SKIP_INSTALL=NO IPHONEOS_DEPLOYMENT_TARGET=13.0 -archivePath web3.swift-iphoneos.xcarchive -destination generic/platform=iOS
xcodebuild archive -scheme web3.swift -sdk iphonesimulator BUILD_LIBRARY_FOR_DISTRIBUTION=YES SKIP_INSTALL=NO IPHONEOS_DEPLOYMENT_TARGET=13.0 -archivePath web3.swift-iphonesimulator.xcarchive -destination generic/platform=iOS
​
